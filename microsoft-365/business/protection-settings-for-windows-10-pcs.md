...
Vis en video om hvordan du sikrer Windows 10-enheter med Microsoft 365 for bedrifter:
...
Hvis du vil ha mer informasjon, kan du se [Hvordan beskytte funksjoner i Microsoft 365 Premium-kart til Intune-innstillinger](map-protection-features-to-intune-settings.md). 
...
|Gi brukere tilgang til Cortana  <br/> |Cortana kan være svært nyttig! Cortana kan slå innstillinger på eller av for deg, gi veibeskrivelser og sørge for at du er i tide for avtaler, slik at vi holder denne innstillingen **på** som standard.  <br/> |
