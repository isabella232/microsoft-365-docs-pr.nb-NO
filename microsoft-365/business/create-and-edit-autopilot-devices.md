...
3. Bla til en [CSV-fil](https://docs.microsoft.com/microsoft-365/admin/misc/device-list) for enhetsliste som \> du klarreder **Lagre** \> **lukk**, i panelet Legg **til enheter** .
