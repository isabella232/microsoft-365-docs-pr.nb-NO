...
Se [Kontrollere at enheten er koblet til Azure AD](#verify-the-device-is-connected-to-azure-ad) for å bekrefte at du har oppgraderingen, eller for å forsikre deg om at oppgraderingen fungerte.
...
Når alle Windows-enheter i organisasjonen enten er oppgradert til Windows 10 Pro Creators Update eller allerede kjører Windows 10 Pro Creators Update, kan du koble disse enhetene til organisasjonens Azure Active Directory. Når enhetene er slått sammen, oppgraderes de automatisk til Windows 10 Business, som er en del av Microsoft 365 Business Premium-abonnementet.
...
2. Her velger du **Konfigurer for en organisasjon,** og deretter skriver du inn brukernavn og passord for Microsoft 365 Business Premium. 
...
5. Skriv inn jobb- eller skolekontoen neste på **siden La oss få deg pålogget.** \> **Next**
  
   Skriv **inn** passordet Logg inn på siden Skriv inn \> **Sign in**passord.
...
Hvis du har lastet opp filer til OneDrive for Business, synkroniser dem tilbake. Hvis du brukte et tredjepartsverktøy til å overføre profil og filer, synkroniserer du også dem til den nye profilen.
  
## <a name="verify-the-device-is-connected-to-azure-ad"></a>Kontroller at enheten er koblet til Azure AD

Hvis du vil bekrefte synkroniseringsstatusen, klikker du i området **Koblet til** _ _på siden Få tilgang til **arbeid eller skole** i **Innstillinger**for å \<organization name\> vise knappene **Info** og **Koble fra**. Klikk på **Informasjon** for å få synkroniseringsstatusen. 
...
Hvis du vil begynne å bruke Microsoft 365 Business Premium-kontoen, går du til **Start-knappen** i Windows, høyreklikker gjeldende kontobilde og **bytter**konto . Logg på ved hjelp av organisasjons e-post og passord.
...
Kontroller at Azure AD-en som ble med i Windows 10-enheter, ble oppgradert til Windows 10 Business som en del av Microsoft 365 Business Premium-abonnementet.
